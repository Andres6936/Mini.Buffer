...
//-------------------------------------
void
mfb_set_keyboard_callback(std::function <void(struct mfb_window*, mfb_key, mfb_key_mod, bool)> func,
...
//-------------------------------------
void
mfb_set_mouse_scroll_callback(std::function <void(struct mfb_window*, mfb_key_mod, float, float)> func,
		struct mfb_window* window)
{
	using namespace std::placeholders;
